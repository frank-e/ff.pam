...
set DEST=%~dpn1.mp3
if /I "%~x1" == ".MP3"  goto DEST
set EXEC=%EXEC% -i "%NEED%" -vn -c:a libmp3lame -q:a 2 "%DEST%"
echo %EXEC% 1>&2
%EXEC%
...
echo Usage: %0 FILE
echo/
echo This script uses (the first) ffmpeg.exe in the PATH
echo for a conversion to MP3 (any video stream removed.)
echo/
